			...
			<table class="table table-bordered table-striped table-hover">
				...
				<c:forEach var="notice" items="${ noticeList }">
					<tr>
						...
						<td align="left"><a href="getNotice.do?title=${ notice.noti_title}">${notice.noti_title }</a></td>
						<td><fmt:formatDate value="${notice.noti_regDate }" pattern="yyyy-MM-dd"/></td>
						
						<c:if test="${ sessionScope.isAdmin }"><td align="center">
							<a href="deleteNotice.do?noti_title=${ notice.noti_title }" class="btn btn-danger"><i class="fas fa-trash"></i></a>
						</td>
						</c:if>
					</tr>
				</c:forEach>			
