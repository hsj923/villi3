											...
											<div class="row justify-content-md">
												<div class="col-md-auto">
													...
													<select class="form-select" id="searchType"
														...
														<option value="detailedcate"
															${searchVO.getSearchType()=="detailedcate" ? "selected" : ""}>카테고리</option>
													</select>
												</div>
					...
					<div class="col-12 col-md-6 col-lg-3 mt-5">
						<div class="card">
							<img class="card-img-top"
								src="resources/images/${ board.fileName1 }" alt="image">
							<div class="card-body">
								<h6 class="card-title fw-bold">
									<a href="getBoard.do?seq=${board.seq}" class="link-dark"
