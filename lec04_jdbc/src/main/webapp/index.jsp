...
<body>
		...
		<div class="container border-bottom border-dark">
			<div class="row align-items-start mt-3 p-3 opacity-100">
				...
				<div class="col" align="center">
					<a href="getBoardList.do"><img src="resources/images/logo.png"
						alt="logo" width=90px height=90px></a>
				</div>

				<div class="col mt-2 text-end">
					<a href="#"><i class="fas fa-heart fa-3x text-dark"></i></a> <span
						class="mx-4"><a href="getUserList.do"><i
	...
	<div id="carouselExampleControls"
		class="carousel carousel-dark slide mt-3" data-bs-ride="carousel"
		align="center">
	...
	<div class="container mt-3 bg-white sticky-top z-index-10">
		<div
			class="row border-bottom border-dark border-top border-dark mt-3 p-3">
			<div class="col" align="center">
					...
					<c:when test="${boardList != null && fn:length(boardList) > 0 }">
						<c:forEach items="${boardList}" var="board">
							...
							<c:if test="${ !empty  board.fileName1}">
								<td align="center"><img
									src="resources/images/${ board.fileName1 }"
									class="d-block w-50 card-img-top embed-responsive-item border border-dark mt-3"
									alt="img" width="350" height="350">
							</c:if>
							<!-- 사진이 없으면 -->
							<c:if test="${ empty  board.fileName1}">
								<td align="center"><img src="resources/images/noimg.png"
									class="d-block w-50 card-img-top embed-responsive-item border border-dark mt-3"
									alt="img" width="350" height="350">
							</c:if>


							<a href="getBoard.do?seq=${ board.seq}"><h4>${board.title}</h4></a>
							<h5>${board.writer}/ ${board.regDate}</h5>  대충위치자리  대충좋아요자리  대충조회수자리</td>
							<c:if test="${i%j == j-1}">
								</tr>
							</c:if>
		...
		<div class="row align-items-start">
			...
			<ul class="col pagination justify-content-center">
				...
				<c:if test="${ pageInfo.getStartPage() != 1 }">
					<li class="page-item"><a href="getBoardList.do?p=1"
						class="page-link"><i class="fas fa-fast-backward"></i></a></li>
					<li class="page-item"><a
						href="getBoardList.do?p=${ pageInfo.getStartPage() - 10 }"
				...
				<c:forEach var="page" begin="${ pageInfo.getStartPage() }"
					...
					<li class="page-item ${ (cp==page) ? 'active' : ''}"><a
						href="getBoardList.do?p=${page}" class="page-link">${page}</a></li>
				</c:forEach>

				<c:if test="${ pageInfo.getEndPage() < pageInfo.getTotalPages() }">
					<li class="page-item"><a
						href="getBoardList.do?p=${ pageInfo.getEndPage() + 1 }"
						class="page-link"><i class="fas fa-forward"></i></a></li>
					<li class="page-item"><a
						href="getBoardList.do?p=${ pageInfo.getTotalPages() }"
