			...
			<div class="row align-items-start mt-3 p-3 opacity-100">
				...
				<div class="col" align="center">
					<a href="../getBoardList.do"><img
						src="../resources/images/logo.png" alt="logo" width=90px
						height=90px></a>
				</div>
		...
		<div class="container mt-3" align="center">
			...
			<div class="input-group mb-3">
				...
				<label class="input-group-text" for="uploadFile4"><i
					...
					aria-label="Upload"> <label class="input-group-text"
					for="uploadFile4"><i class="fas fa-file"></i></label> <input
					type="file" class="form-control" name="uploadFile4"
					id="uploadFile4" aria-describedby="uploadFile" aria-label="Upload">


				<label class="input-group-text" for="uploadFile5"><i
					class="fas fa-file"></i></label> <input type="file" class="form-control"
					name="uploadFile5" id="uploadFile5" aria-describedby="uploadFile"
					aria-label="Upload">
			</div>
