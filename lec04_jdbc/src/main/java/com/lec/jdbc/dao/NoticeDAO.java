...
public class NoticeDAO {
	...
	public NoticeVO getNotice(NoticeVO notice) {
		Object[] args = { notice.getNoti_title() };
		return jdbcTemplate.queryForObject(get_notice, args, new NoticeRowMapper());

	}

	public int insertNotice(NoticeVO notice) {
		return jdbcTemplate.update(insert_notice, notice.getNoti_seq(), notice.getNoti_title(), notice.getNoti_content(), notice.getNoti_regDate());
	}

	public int deleteNotice(NoticeVO notice) {
		return jdbcTemplate.update(delete_notice, notice.getNoti_title());
	}
