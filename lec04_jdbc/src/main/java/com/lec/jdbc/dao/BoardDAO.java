...
public class BoardDAO {
	...
	private String insert_sboard     = ""; //"insert into board(title, writer, content, filename1, filename2, filename3, filename4, filename5, category, regdate) values(?, ?, ?, ?, ?, ?, ?, ?, ?, now())";
	...
	public void getSqlPropeties() {
		...
		insert_sboard     = environment.getProperty("insert_sboard");
	...
	public int insertBoard(BoardVO board) {
		return jdbcTemplate.update(insert_board, board.getTitle(), board.getWriter(), board.getContent(), board.getFileName1(),board.getFileName2()
				,board.getFileName3(), board.getFileName4(), board.getFileName5(), board.getCate2(), board.getPrice());
	}
	public int insertsBoard(BoardVO board) {
		return jdbcTemplate.update(insert_sboard, board.getTitle(), board.getWriter(), board.getContent(), board.getFileName1(),board.getFileName2()
				,board.getFileName3(), board.getFileName4(), board.getFileName5(), board.getCate2(), board.getPrice());
	}
